    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Transaksi : Debit</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <form enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Pilih Periode Transaksi Debit</label>
                            ...
                            <div class="panel-body">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT 
                                                ...
                                                CONCAT_WS('',a.debet,b.debet) AS nominal
                                                
                                                FROM jurnal AS a LEFT OUTER JOIN jurnal_penyesuaian AS b ON a.no_periode = b.no_periode WHERE a.debet > 0 OR b.debet > 0 AND a.no_periode=1 AND b.no_periode=1;";
