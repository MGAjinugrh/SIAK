...
{
    //echo $row['nama_akun'];
    $stmt = mysqli_query($connect,"INSERT INTO siak.jurnal(no_transaksi,tanggal,no_periode,no_akun,nama_akun,uraian,debet,kredit) VALUES('','".date('Y-m-d H:i:s')."','$no_periode','$no_akun','".$akun['nama_akun']."','$keterangan','$debet','$kredit')") or die(mysql_error());
}
